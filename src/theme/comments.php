...
if ( ! comments_open() && get_comments_number() && post_type_supports( get_post_type(), 'comments' ) ) : ?>
	<div class="no-comments-area py-6 px-1 px-sm-6 shadow bg-surface-primary rounded-4 min-w-0">
		<p class="no-comments">
...
if ( comments_open() ) : ?>
	<div class="py-6 px-1 px-sm-6 shadow bg-surface-primary rounded-4 min-w-0">
		<?php comment_form(); ?>
	</div>
<?php endif;
